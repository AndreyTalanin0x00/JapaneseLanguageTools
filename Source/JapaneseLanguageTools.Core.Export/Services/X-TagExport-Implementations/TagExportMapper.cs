...
public class TagJsonExportMapper :
    AutoMapperExportMapperBase<TagExportRequest, TagExportResponse, TagObjectPackageJsonModel, TagObjectPackageIntegrationModel>
{
    public TagJsonExportMapper(IMapper mapper)
        : base(mapper)
    {
    }
}
...
public class TagXmlExportMapper :
    AutoMapperExportMapperBase<TagExportRequest, TagExportResponse, TagObjectPackageXmlModel, TagObjectPackageIntegrationModel>
{
    public TagXmlExportMapper(IMapper mapper)
        : base(mapper)
    {
    }
}
