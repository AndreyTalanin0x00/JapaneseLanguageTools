...
{
    /// <inheritdoc />
    public Task<ApplicationDictionaryImportResponse> ProcessAsync(ApplicationDictionaryImportRequest applicationDictionaryImportRequest, ImportObjectPackageBatch<Object, ApplicationDictionaryObjectPackageIntegrationModel>[] importObjectPackageBatches, CancellationToken cancellationToken = default)
    {
