...
public class TagImportReader :
    IImportReader<TagImportRequest, TagImportResponse>
{
    /// <inheritdoc />
    public Task<ImportSourceBatch[]> ReadAsync(TagImportRequest tagImportRequest, CancellationToken cancellationToken = default)
    {
