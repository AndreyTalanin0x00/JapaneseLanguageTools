...
[XmlRoot(ApplicationDictionaryObjectPackageXmlElementName)]
public class ApplicationDictionaryObjectPackageXmlModel
{
    public const string ApplicationDictionaryObjectPackageXmlElementName = "ApplicationDictionaryObjectPackage";
    ...
    [XmlElement]
    public ApplicationDictionaryXmlModel ApplicationDictionary { get; set; } = new();
