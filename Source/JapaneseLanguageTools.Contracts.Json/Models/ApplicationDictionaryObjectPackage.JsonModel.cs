...
public class ApplicationDictionaryObjectPackageJsonModel
{
    ...
    [JsonPropertyName("applicationDictionary")]
    public ApplicationDictionaryJsonModel ApplicationDictionary { get; set; } = new();
